...
def main():
    ...
    user_formula = input('Enter the molecular formula of the sample (Example: C6H6): ')
    # Get the mass of a chemical sample in grams from the user.
    user_mass = float(input('Enter the mass in grams of the sample (Example: 25.04): '))
    ...
    symbol_quantity_list = parse_formula(user_formula, periodic_table_dict)
    ...
    moles = compute_moles(molar_mass, user_mass)

    molecule_name = get_formula_name(user_formula)

    protons = sum_protons(symbol_quantity_list, periodic_table_dict)

    print()
    print(f'Information for this sample of {molecule_name} molecule: ')
...
def sum_protons(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        ...
        protons = periodic_table_dict[symbol][PROTON_INDEX]

        sample_protons = protons * quantity

        total_protons += sample_protons
...
def compute_moles(molar_mass, user_mass):
    moles = user_mass / molar_mass
    return moles
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        ...
        sample_atomic_mass = atomic_mass * quantity

        # Add the product into the total molar mass.
        total_molar_mass += sample_atomic_mass
    
    # Return the total molar mass.
    return total_molar_mass

def make_periodic_table():
    """Makes the periodic table list so it can be used elsewhere"""
