...
def main():
    ...
    frm_main = Frame(root)
    frm_main.master.title("Pie Formula")
...
def populate_main_window(frm_main):
    ...
    lbl_final_area = Label(frm_main, width=5)
    # lbl_fast = Label(frm_main, width=3)
    lbl_area_units = Label(frm_main, text="inches/squared")
    ...
    lbl_final_area.grid(      row=1, column=1, padx=3, pady=3)
